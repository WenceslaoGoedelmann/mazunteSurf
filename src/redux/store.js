...
const persistConfig = { /* creo el objeto de configuracion para guardar datos en el local storage, luego lo voy a utilizar en persistReducer */
  ...
  whitelist: ['turnos','user'] /* con esta propiedad indico los reducers que deseeo que se guarden en el local storage, si hago esto se guardaria todos los reducers y por lo general no queremos guardar todos */
};
